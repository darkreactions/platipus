...
python GradientBoosting.py --datasource=drp_chem --train_size=20 --cross_validate --full --verbose
python GradientBoosting.py --datasource=drp_chem --train_size=20 --cross_validate --pretrain --full --verbose

Run the following command lines for test dataset training (debug):
python GradientBoosting.py --datasource=drp_chem ---train_size=20 -cross_validate --verbose
python GradientBoosting.py --datasource=drp_chem --train_size=20 --cross_validate --pretrain --verbose
"""
...
class ActiveGradientBoosting:
    ...
    def active_learning(self, num_iter=None, to_params=True):
        ...
        This is the active learning model that loops around the Gradient Boosting model
...
def main():
    ...
    GradientBoosting_params = vars(parse_args())

    run_model(GradientBoosting_params)
